...
grids = [
    {
        "main_file": ["main.py"],
        "pretrained_model": ["gpt2", "EleutherAI/pythia-70m", "EleutherAI/pythia-160m", "EleutherAI/pythia-410m", os.environ["SCRATCH"]+r"/Meta-Llama-3-8B"][2:3],
        ...
        "concat": [False],
        #"context_length": [128],
        "new_word": ["<|new_word|>", "<|reserved_special_token_0|>"][0:1],
        "no_new_token": [False],
        "embedding_init": ["mean"],
        "prompt": [
            "",
        ...
        "sep": [" *", "<|sep|>", "<|reserved_special_token_1|>"][1:2],
